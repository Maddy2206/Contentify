export default  [
    ...
    },
    {
        ...
        desc: 'An AI tool that generates email based on the description provided by the user',
        icon: 'https://cdn-icons-png.flaticon.com/128/732/732200.png',
        category: 'Email',
        slug: 'email-generator',
        aiPrompt: 'Please write an email body based on the following description:',
        form: [
            {
                label: 'Enter the description of your email in 30-40 words',
                field: 'textarea',
                name: 'outline',
                required:true
            }
